def get_info(type_name: str = None) -> None:
    ...
    for nw_class in nw_class_list:
        type_names.append(str(nw_class).lstrip("<class ").rstrip(">"))
    ...
    if type_name:
        ...
        if not exists:
            ...
            return
        print(type_name)
        print(nw_class_list[type_name_index].__doc__)
        print(nw_class_list[type_name_index].__init__.__doc__)
    else:
